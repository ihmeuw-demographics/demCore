...
utils::globalVariables(
  c("age_int", "age_group_years_start", "age_group_years_end",
    "test", "px", "qx", "lx", "dx", "mx", "ax", "ex", "Tx", "nLx", "nSx",
    ...
    "qx_inf", "statistic",
    "Di", "Pi", "a_i", "b_i", "c_i", "age_end_nqx", "age_start_nqx",
    "id", "model", "type", "sbh_trussell_coeffs"
  )
)
